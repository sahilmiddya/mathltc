...
var _excluded27 = ["theme"];
function ThemeProvider(_ref) {
  let {
    theme: themeInput
  } = _ref, props = _objectWithoutPropertiesLoose(_ref, _excluded27);
  const scopedTheme = themeInput[identifier_default];
  return (0, import_jsx_runtime47.jsx)(ThemeProvider_default, _extends({}, props, {
...
// node_modules/@mui/material/styles/experimental_extendTheme.js
var _excluded28 = ["colorSchemes", "cssVarPrefix", "shouldSkipGeneratingVar"];
var _excluded29 = ["palette"];
...
function extendTheme(options = {}, ...args) {
  ...
  } = options, input = _objectWithoutPropertiesLoose(options, _excluded28);
  const getCssVar = createGetCssVar2(cssVarPrefix);
  const _createThemeWithoutVa = createTheme_default(_extends({}, input, colorSchemesInput.light && {
    palette: (_colorSchemesInput$li = colorSchemesInput.light) == null ? void 0 : _colorSchemesInput$li.palette
  })), {
    palette: lightPalette
  } = _createThemeWithoutVa, muiTheme = _objectWithoutPropertiesLoose(_createThemeWithoutVa, _excluded29);
  const {
    palette: darkPalette
  } = createTheme_default({
    palette: _extends({
...
var Tooltip = React72.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React72.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime49.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  ...
  return (0, import_jsx_runtime50.jsxs)(React72.Fragment, {
    children: [React72.cloneElement(children, childrenProps), (0, import_jsx_runtime49.jsx)(PopperComponent, _extends({
      ...
      children: ({
        ...
        children: (0, import_jsx_runtime50.jsxs)(TooltipComponent, _extends({}, tooltipProps, {
          children: [title, arrow2 ? (0, import_jsx_runtime49.jsx)(ArrowComponent, _extends({}, tooltipArrowProps, {
            ref: setArrowRef
          })) : null]
        }))
      }))
